...
import { loadMovies, getMovie, addMovie, updateMovie, deleteMovie, filterMovies, sortMovies, searchMovies } from '../../../store/movies/thunk';
...
describe('async actions', () => {
    ...
    it('dispatches FILTER_MOVIES and creates SET_MOVIES when success', () => {
        ...
        const genre = 'Comedy';
        let response = [{id: 123}, {id: 222}];
        mockAxios.onGet("http://127.0.0.1:4000/movies/", { params: { filter: genre,
                limit: 40, } }).reply(200, {data: response});
    ...
    it('dispatches SORT_MOVIES and creates SET_MOVIES when sort movies has been done', () => {
        ...
        let response = [{id: 123}, {id: 222}];
        mockAxios.onGet("http://127.0.0.1:4000/movies/", { params: { sortBy: type,
                sortOrder: 'desc',
                limit: 40, } }).reply(200, {data: response});
    ...
    it('dispatches SEARCH_MOVIES and creates SET_MOVIES when search movies has been done', () => {
        // simulating a server response
        const query = 'black';
        let response = [{id: 123, title: 'Black house'}, {id: 222, title: 'Men in black'}];
